...
# CUDA_VISIBLE_DEVICES=0 bash eval_papers.sh nllb_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_papers.sh seamless_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_papers.sh gpt4omini_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_papers.sh aya_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_papers.sh aya_old_hard_replace_morphology

# CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh nllb_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh seamless_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh gpt4omini_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh aya_hard_replace_morphology
# CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh aya_old_hard_replace_morphology

CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama3_8b
CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama3_8b_hard_replace
CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama3_8b_prompt_gpt4omini
CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama31_8b
CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama31_8b_hard_replace
CUDA_VISIBLE_DEVICES=0 bash eval_6060.sh llama31_8b_prompt_gpt4omini