...
#     --in_file /home/jiaruil5/multilingual/multilingual-model-card/multilingualmc/dataset/output/${model}_prompt_gpt4omini.jsonl \
#     --out_file /home/jiaruil5/multilingual/multilingual-model-card/multilingualmc/dataset/output/${model}_prompt_gpt4omini_morphology.jsonl \
...
# python3 run_on_6060_prompt_morphology.py \
#     --in_file /home/jiaruil5/multilingual/multilingual-model-card/multilingualmc/dataset/output/${model}_hard_replace.jsonl \
#     --out_file /home/jiaruil5/multilingual/multilingual-model-card/multilingualmc/dataset/output/${model}_hard_replace_morphology.jsonl \
#     --term_file_path /home/jiaruil5/multilingual/multilingual-model-card/multilingualmc/dictionary_collection/mturk/analysis/annotation_final/ \
#     --model gpt-4o-mini
