...
# python3 eval_on_6060_comet_japanese.py --in_file /home/ubuntu/multilingual-model-card/src/data_eval_6060/output/predictions_dev_seamless_prompt_japanese.jsonl --out_file /home/ubuntu/multilingual-model-card/src/data_eval_6060/eval/predictions_dev_seamless_prompt_japanese_comet_noref_xl.json --model_id Unbabel/wmt23-cometkiwi-da-xl
...
if __name__ == "__main__":
    ...
    for item in in_data:
        ...
        pred_dict['English'].append(item[f'text'])
    ...
    for tgt_lang in tqdm(tgt_langs):
        ...
        for pred_item, eng_item in zip(pred_dict[tgt_lang], pred_dict['English']):
            info = {
                "src": eng_item,
                "mt": pred_item,
            }
